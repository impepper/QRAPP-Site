...
<body>
	<div class="container">
		...
		<p>This library includes three examples: <a href="example-purchase.php">Simple Purchase</a>, <a href="ppal_subscription.php">Simple Subscription</a> and <a href="example-subscription-checkout.php">Subscription with Separate Checkout page</a>.</p>
		...
		<p><a href="ppal_subscription.php">Try the Simple Subscription Example &raquo;</a></p>
