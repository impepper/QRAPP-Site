...
var require = {
	...
	ti: {
		buildHash: "a59dbdb",
		buildDate: "09/27/12 18:16",
		filesystem: {
			registry: "ondemand"
		},
		theme: "default",
		version: "2.1.3.v20120927181611"
	},
	vendorPrefixes: {
...
p.setString("acs-api-key-production","n7MsybAWCWZApQv1MKLVKTwAK6X65aPs");
p.setString("acs-api-key-development","LGw5sY0z72d1Qlced8dN2N8K3zKAcwo9");
p.setString("acs-oauth-secret-development","9uGJIEhrwBBK0BK3Tkd6KpxRyVYq4ldZ");
p.setString("ti.map.apikey","");
p.setString("ti.ui.defaultunit","system");
p.setString("acs-oauth-secret-production","G9hDIrjjAWUaRqvBwEpXxmUls8zYKM70");
p.setString("acs-oauth-key-development","pEn5tvLeSD8v1QaC3UAW74tXKE2KiNJI");
p.setString("ti.map.backend","Ti/_/Map/Google");
p.setString("ti.fs.backend","Ti/_/Filesystem/Local");
p.setString("acs-oauth-key-production","tfV8s02WZEqv3qDhZUSHolwMu0ToO2fl");
});
